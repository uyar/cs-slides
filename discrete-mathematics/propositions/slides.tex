...
\subsection{Propositional Logic Language}

\begin{frame}
  \frametitle{Propositional Logic Language}
  ...
  \begin{block}{semantics}
    \begin{itemize}
      \item \emph{interpretation}: calculating the value of a
        ...
        by assigning values to its propositional variables
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item substituting logically equivalent formulas for one another
    \end{itemize}
