...
\begin{frame}
  ...
  \begin{tanim}
    \alert{önerme}: doğru ya da yanlış olan bir bildirim cümlesi
  \end{tanim}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \alert{doğruluk tablosu}:\\
      önerme değişkenlerinin olası bütün değerleri için\\
...
\begin{frame}
  ...
  \begin{itemize}
    \item hesap sırasını değiştirmek için parantez kullanılır
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{İşlem Önceliği Örnekleri}
...
\begin{frame}
  ...
  \begin{ornek}
    \begin{itemize}
      \item anadili Türkçe olan biri İngilizce öğrenirken
      \begin{itemize}
  ...
  \begin{ornek}
    \begin{itemize}
      \item bir öğrenci programlama öğrenirken
      \begin{itemize}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \begin{itemize}
      \item değişken sayısı artınca yönetimi zorlaşır
    \end{itemize}
