...
\begin{frame}
  ...
  \pause
  \begin{tanim}
    \alert{hareket}: bir iþin mantýksal bir birimi
  \end{tanim}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item kalýcýlýk
    \begin{itemize}
      \item sonlandýrýldýktan sonra sistem çökse de veriler bir zarar görmez
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item veri, sistemde baþka yerde yazýlý verilerden türetilebilmeli
      \item iç düzeyde
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item \alert{günlük} her iþlemden etkilenen her çoklunun\\
      iþlemden önceki ve sonraki deðerlerini tutar

    \pause
    \medskip
    \item \alert{günlüðe önceden yazma kuralý}:\\
      hareket sonlanmadan önce günlük fiziksel ortama yazýlmalý

    \pause
    \medskip
    \item günlük kayýtlarýna eriþim iþlemin doðasý gereði ardýþýl
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item geri alma - sonlandýrma sistemleri ayrý
    \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \pause
    \item A hareketinin kilit isteði\\
      B hareketinin tuttuðu bir kilitle çeliþiyorsa:
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item sonlandýrýlanlarý okuyabilme
      \item sonlandýrýlmayanlarý okuyabilme
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \alert{serileþtirilebilir}: eþzamanlý çalýþmanýn sonucu\\
      her zaman seri çalýþtýrmalardan birinin sonucu ile ayný
  \end{itemize}
...
\begin{frame}[fragile]
  \frametitle{Sonlandýrýlanlarý Okuyabilme}
