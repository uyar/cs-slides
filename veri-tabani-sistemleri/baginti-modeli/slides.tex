...
\begin{frame}
  ...
  \begin{ornek}[film baðýntýsýnýn yüklemi]
    \begin{itemize}
      \item \texttt{TITLE} baþlýklý film \texttt{YEAR} yýlýnda, \texttt{DIRECTOR}
        tarafýndan,\\
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item her çoklu diðerlerinden ayýrt edilebilmelidir
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item ayný niteliðe iliþkin bütün deðerler\\
      ayný taným kümesinden seçilmeli
    ...
    \pause
    \medskip
    \item pratikte çoðunlukla veri tipleri kullanýlýr
  \end{itemize}
\end{frame}
  ...
  \begin{ornek}
    \begin{itemize}
      ...
      \item veri tipi kullanýlýrsa:\\
        \texttt{TITLE} katar, \texttt{YEAR} tamsayý, \texttt{COUNTRY} katar, ...
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item geçerli deðerlerden biri olmamalý
    \end{itemize}
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item baðýntý yüklemine uymayan çoklularýn engellenmesi
...
\begin{frame}
  ...
  \begin{ornek}
    \begin{itemize}
      \item \texttt{YEAR} deðerleri \texttt{1888}'den küçük olamaz
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item görünür olmalarý gerekmiyor
...
\begin{frame}
  ...
  ID & TITLE                & YEAR & DIRECTOR      & ...\\\hline\hline
 ... & ...                  &  ... & ...           & ...\\\hline
...
\begin{frame}
  ...
  \begin{ornek}
    ...
    \begin{table}
      \caption{MOVIE}
      \begin{tabular}{|r|l|r|l|c|}\hline
\underline{ID} & TITLE                & YEAR & DIRECTOR      & ...\\\hline\hline
           ... & ...                  &  ... & ...           & ...\\\hline
             6 & Usual Suspects       & 1995 & Bryan Singer  & ...\\\hline
          1512 & Suspiria             & 1977 & Dario Argento & ...\\\hline
            70 & Being John Malkovich & 1999 & Spike Jonze   & ...\\\hline
