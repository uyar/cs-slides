...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item yazýlýmda: nesne, yöntem, \ldots
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{ornek}[filme oyuncu ekleme - SQL tanýmlarý]
...
\begin{frame}[fragile]
  ...
  \begin{ornek}[filme oyuncu ekleme - SQL iþlemleri]
    \begin{lstlisting}[language=FullSQL]
...
\begin{frame}[fragile]
  ...
  \begin{ornek}[filme oyuncu ekleme - Java tanýmlarý]
    \begin{lstlisting}
public class Movie {
    ...
...
\begin{frame}[fragile]
  ...
  \begin{ornek}[filme oyuncu ekleme - Java iþlemleri]
    \begin{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item veri tabanýna baðlantý (gömülü kip):\\
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    ...
    \item bu sýnýfýn \lstinline!match! yöntemi gerçeklenir:\\
  ...
  \begin{itemize}
    \item sorgulama: bir sýnýftan bütün nesneler\\
      \lstinline!Persist.readList(Class.class)!
       $\rightarrow$ \lstinline!List<Class>!
    \item SQL ile sorgulama: hazýr komut yazýmýna benzer þekilde\\
      \lstinline!Persist.readList(Class.class, String query, parameters)!\\
       $\rightarrow$ \lstinline!List<Class>!
  \end{itemize}
\end{frame}
