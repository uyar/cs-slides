% Copyright (c) 2004-2017 H. Turgut Uyar <uyar@itu.edu.tr>
%
...
\pgfdeclareimage[width=8cm]{schmidt1}{schmidt1}
\pgfdeclareimage[width=6.5cm]{zuckerberg}{zuckerberg}
\pgfdeclareimage[width=6cm]{schneier}{schneier}
\pgfdeclareimage[width=6.5cm]{pennsylvania}{pennsylvania}
\pgfdeclareimage[width=6cm]{iphone}{iphone}
\pgfdeclareimage[width=6cm]{rfid-immigrants}{rfid-immigrants}
\pgfdeclareimage[height=6.5cm]{nsa-google}{nsa-google}
\pgfdeclareimage[height=6cm]{nsa-prism}{nsa-prism}
\pgfdeclareimage[width=5.8cm]{schmidt2}{schmidt2}
\pgfdeclareimage[width=6.2cm]{burglars}{burglars}
\pgfdeclareimage[width=5.3cm]{street-view}{street-view}
\pgfdeclareimage[width=6.2cm]{oz}{oz}
\pgfdeclareimage[width=6.8cm]{zuckerberg-photos}{zuckerberg-photos}
\pgfdeclareimage[width=6.5cm]{playstation}{playstation}
\pgfdeclareimage[width=5.8cm]{ashley-madison}{ashley-madison}
\pgfdeclareimage[height=6.5cm]{redhack}{redhack}
\pgfdeclareimage[width=8cm]{aol}{aol}
\pgfdeclareimage[width=6.5cm]{mernis}{mernis}
\pgfdeclareimage[width=5.8cm]{bork}{bork}
\pgfdeclareimage[width=6cm]{schaeffer}{schaeffer}
\pgfdeclareimage[width=6.5cm]{toysmart}{toysmart}
\pgfdeclareimage[width=6.5cm]{myspace}{myspace}
\pgfdeclareimage[width=4cm]{abacus}{abacus}
