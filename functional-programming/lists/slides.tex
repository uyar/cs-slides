...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item convert two lists into a list of pairs\\
      \pygment{haskell}{zip [1,2] [3,4]} $\rightsquigarrow$
      \pygment{haskell}{[(1,3),(2,4)]}
  \end{itemize}
...
zip' (x:xs) (y:ys) = (x,y) : zip' xs ys
  ...
  \begin{itemize}
    \item what if called as:\\
      \pygment{haskell}{zip' [1,2] [3,4,5]}
    \item result should be: \pygment{haskell}{[(1,3),(2,4)]}
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item convert three lists into a list of triples\\
      \pygment{haskell}{zip3 [1,2] [3,4] [5,6]} $\rightsquigarrow$
      \pygment{haskell}{[(1,3,5),(2,4,6)]}
    \item using a \pygment{haskell}{case} expression
  \end{itemize}
...
maxList1 (x:xs)
  ...
  \begin{itemize}
    \item what happens if called as:\\
      \pygment{haskell}{maxList1 [30,29 .. 1]}\\
      \pygment{haskell}{maxList1 [1 .. 30]}
  \end{itemize}
\end{frame}
