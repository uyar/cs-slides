...
\begin{frame}
  ...
  \begin{example}
    \begin{itemize}
      \item the name, number and department of the student is kept\\
...
\begin{frame}
  ...
  \begin{itemize}
    \item the correctness of data is difficult to achieve
  \end{itemize}

  \pause
  \begin{example}
    \begin{itemize}
      \item student transfers from "Civil Engineering"\\
...
\begin{frame}
  ...
  \begin{itemize}
    \item same work has to be done for every new application
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item different paradigms, methods, programming languages, etc.
