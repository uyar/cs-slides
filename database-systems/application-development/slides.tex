...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      \item fast, standard
      \item difficult, does not support most languages
    \end{itemize}
...
%   \begin{block}{Communication Area}
%     \begin{lstlisting}
% EXEC SQL INCLUDE sqlca;
%     \end{lstlisting}
%
%     \begin{itemize}
%       \item \lstinline!sqlca.sqlcode!: status of last executed statement
%     \end{itemize}
%   \end{block}
%
%   \pause
...
\begin{frame}
  ...
  \begin{itemize}
    \item \lstinline!Statement!: SQL statement
    \begin{itemize}
    ...
    \pause
    \medskip
    \item \lstinline!PreparedStatement!: precompiled SQL statement
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{block}{Required text: Ramakrishnan, Gehrke}
    \begin{itemize}
      \item Chapter 6: Database Application Development
      \begin{itemize}
        \item 6.1. Accessing Databases from Applications
        \item 6.2. \alert{An Introduction to JDBC}
        \item 6.3. \alert{JDBC Classes and Interfaces}
      \end{itemize}
    \end{itemize}
  \end{block}

  \begin{block}{Supplementary text: Date}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \pause
    \bigskip
    \item \alert{not really recommended}
    \begin{itemize}
      \item not portable
...
\begin{frame}
  ...
  \begin{block}{Required text: Date}
    \begin{itemize}
      ...
      \item Chapter 17: Security
      \begin{itemize}
        \item 17.1. \alert{Introduction}
        \item 17.6. \alert{SQL Facilities}
      \end{itemize}
    \end{itemize}
  \end{block}
\end{frame}
