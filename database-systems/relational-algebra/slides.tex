...
\begin{frame}[fragile]
  ...
  \begin{example}[years of movies with the title "Citizen Kane"]
    \begin{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{example}[names of the directors of the movies\\
...
\begin{frame}[fragile]
  ...
  \begin{example}[names of the actors of the movies with the title "Alien"]
     \begin{lstlisting}
SELECT NAME
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles of movies where actors\\
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles and names of the lead actors of the movies in 1962]
    \begin{lstlisting}
SELECT TITLE, NAME
  FROM MOVIE, PERSON, CASTING
  WHERE ((YR = 1962)
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles of movies with no known actors]
    \begin{lstlisting}
SELECT TITLE
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles and scores of all movies with scores\\
                  higher than that of "Star Wars", in descending order of
                  scores]
\uncover<3->{
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles of movies with more votes\\
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles of movies with scores less than\\
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles of movies with less votes\\
...
\begin{frame}[fragile]
  ...
  \begin{example}[number of movies John Travolta acted in every year]
...
\begin{frame}[fragile]
  ...
  \begin{example}[titles and number of actors of the movies in 1978,\\
                  in ascending order of actor counts]
