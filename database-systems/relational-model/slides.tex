...
\begin{frame}
  ...
  \begin{itemize}
    \item in order to meet the scalar value requirement,\\
      tuples may have to be repeated
  \end{itemize}
...
\begin{frame}
  ...
  \begin{definition}
    \alert{foreign key}: an attribute of a relation\\
      being the candidate key of another relation
  \end{definition}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{example}[the \texttt{MOVIE\#} attribute of the \texttt{CASTING}
                  relation variable]
    \begin{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{example}[the \texttt{MOVIE} relation variable]
    \begin{lstlisting}
VAR MOVIE BASE RELATION
...
\begin{frame}[fragile]
  ...
  \begin{example}[the \texttt{PERSON} relation variable]
    \begin{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{example}[the \texttt{CASTING} relation variable]
    \begin{lstlisting}
...
\begin{frame}[fragile]
  ...
  \begin{example}[the foreign keys of the \texttt{MOVIE} relation variable]
    \begin{lstlisting}
CONSTRAINT MOVIE_FKEY_DIRECTOR
  MOVIE { DIRECTOR# }
      RENAME (DIRECTOR# AS PERSON#)
...
\begin{frame}[fragile]
  ...
  \begin{example}[the foreign keys of the \texttt{CASTING} relation variable]
    \begin{lstlisting}
CONSTRAINT CASTING_FKEY_MOVIE
...
\begin{frame}[fragile]
  \frametitle{Automatically Incremented Value Examples}
