...
\underline{MOVIE\#} & \underline{ACTOR\#} & ORD\\[2pt]\hline\hline
  ...
  \begin{picture}(0, 0)
    ...
    \thicklines
    \only<2->{
      \put(148, 112){\oval(45, 9)}        % movie.director#
      \put(243, 112){\oval(36, 9)}        % person.person#
      \put(170, 112){\vector(1, 0){54}}   % movie.director# -> person.person#
    }
    \only<3->{
      \put(129,  43){\oval(33, 9)}        % casting.movie#
      \put( 35, 112){\oval(33, 9)}        % movie.movie#
      \put(128,  47){\vector(-4, 3){78}}  % casting.movie# -> movie.movie#
    }
    \only<4->{
...
MOVIE := RELATION
  { TUPLE
      { MOVIE# MOVIE#(6), TITLE "Usual Suspects",
